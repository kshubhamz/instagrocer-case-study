...
@Component
public class InventoryItemDeletedListner implements RabbitMQMessageListner {
	...
	@Override
	@RabbitListener(queues = { InstaGrocerEvent.INVENTORY_ITEM_DELETED })
	public void onMessageReceive(String message) throws JsonProcessingException {
		...
		catalogueItemService.deleteCatalogueItem(inventoryProduct);
		latch.countDown();
	}
