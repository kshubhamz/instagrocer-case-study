...
@Component
public class InventoryItemUpdatedListner implements RabbitMQMessageListner {
	...
	@Override
	@RabbitListener(queues = { InstaGrocerEvent.INVENTORY_ITEM_UPDATED })
	public void onMessageReceive(String message) throws JsonProcessingException {
		...
		catalogueItemService.updateCatalogueItem(inventoryProduct);
		latch.countDown();
	}
